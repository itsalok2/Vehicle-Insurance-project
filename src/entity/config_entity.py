...
class ModelTrainerConfig:
    ...
    trained_model_file_path: str= os.path.join(model_trainer_dir,MODEL_TRAINER_DIR_NAME,MODEL_FILE_NAME)
    ...
    reg_lambda = MODEL_TRAINER_LAMBDA    # L2 regularization
    reg_alpha = MODEL_TRAINER_ALPHA      # L1 regularization
