...
from src.constants import SCHEMA_FILE_APTH
...
class DataValidation:
    def __init__(self,data_ingestion_artifact: DataIngestionArtifact,data_validation_config: DataValidationConfig):
        ...
        try:
            ...
            self._schema_config=read_yaml_file(file_path=SCHEMA_FILE_APTH)
        except Exception as e:
            raise MyException(e,sys)
        
    def validate_number_of_columns(self,dataframe:pd.DataFrame)->None:
        """
    ...
    def initiate_data_validation(self)-> DataValidationArtifact:
        ...
        try:
            ...
            if not status:
                ...
                logging.info(f"All categorical/int columns are present in testing datafream: {status}")
            ...
            validation_report={
                "validatioin_status": validation_status,
