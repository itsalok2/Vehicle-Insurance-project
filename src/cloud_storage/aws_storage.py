...
class SimpleStorageService:
    ...
    def get_bucket(self,bucket_name:str)->Bucket:
        ...
        try:
            ...
            logging.info("existed the get_bucket method of SimpleStorageService class")
            return bucket
        ...
        try:
            if isinstance(object_name,list):
                if len(object_name)==0:
                    raise ValueError('No object provided to read')
    ...
    def get_file_object(self,filename:str,bucket_name:str)->Union[List[object],object]:
        ...
        try:
            ...
            if len(file_objects) == 0:
                logging.warning(f"No object found in bucket '{bucket_name}' with prefix '{filename}'")
    ...
    def create_folder(self,folder_name:str,bucket_name:str)->None:
        ...
        Args:
            ...
            bucket_name (str): Name of the S3 bucket.
        """
        logging.info('Entere in the create_folder method of SimpleStorageService class ')
        try:
    ...
    def upload_df_as_csv(self,dataframe:pd.DataFrame,local_filename:str,bucket_filename:str,bucket_name:str)->None:
        ...
        try:
            # dave dataframe ot csv locally and then upload it
            dataframe.to_csv(local_filename,index=True,header=True)
